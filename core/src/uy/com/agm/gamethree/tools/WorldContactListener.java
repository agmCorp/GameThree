...
public class WorldContactListener implements ContactListener {
    ...
    public void beginContact(Contact contact) {
        ...
        switch (collisionDef) {
            case GameThree.HERO_BIT | GameThree.BORDERS_BIT: // bordes
                fixC = fixA.getFilterData().categoryBits == GameThree.BORDERS_BIT ? fixA : fixB;
            ...
            case GameThree.HERO_BIT | GameThree.OBSTACLE_BIT: // arboles
                ...
                ((InteractiveTileObject) fixC.getUserData()).onHit();
                break;
            case GameThree.HERO_BIT | GameThree.POWERBOX_BIT: // regalos
                fixC = fixA.getFilterData().categoryBits == GameThree.POWERBOX_BIT ? fixA : fixB;
            ...
            case GameThree.HERO_BIT | GameThree.ENEMY_BIT:
                ...
                break;
            case GameThree.ENEMY_BIT | GameThree.BORDERS_BIT:
                fixC = fixA.getFilterData().categoryBits == GameThree.ENEMY_BIT ? fixA : fixB;
            ...
            case GameThree.ENEMY_BIT | GameThree.ENEMY_BIT:
                ...
                break;
            case GameThree.ITEM_BIT | GameThree.BORDERS_BIT:
            ...
            case GameThree.ITEM_BIT | GameThree.ENEMY_BIT:
                ...
                ((Item) fixC.getUserData()).reverseVelocity(true, false);
                break;
            case GameThree.ITEM_BIT | GameThree.POWERBOX_BIT:
                fixC = fixA.getFilterData().categoryBits == GameThree.ITEM_BIT ? fixA : fixB;
                ((Item) fixC.getUserData()).reverseVelocity(true, false);
                break;
