...
public class Constants {
    ...
    public static final float GAMECAM_VELOCITY = 0 * 0.304f;
    ...
    public static final String HUD_FORMAT_SCORE = "%6d";
    public static final String HUD_FORMAT_TIME = "%03d";
    public static final String HUD_FORMAT_LIVES = "%02d";
    ...
    */
    ...
    public static final float POWERTHREE_BULLET_CIRCLESHAPE_RADIUS_METERS = 30.0f / PPM;
    ...
    public static final float FINALLEVELTWO_DYING_STATE_TIME_SECONDS = 2.0f;
