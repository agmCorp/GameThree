...
public class AssetSounds {
    ...
    public AssetSounds(AssetManager am) {
        ...
        openPowerBox = am.get(Assets.FX_FILE_OPEN_POWERBOX, Sound.class);
        clock = am.get(Assets.FX_FILE_CLOCK, Sound.class);
        pickUpColOne = am.get(Assets.FX_FILE_PICK_UP_COLONE, Sound.class);
        pickUpColSilverBullet = am.get(Assets.FX_FILE_PICK_UP_COLSILVERBULLET, Sound.class);
        pickUpPowerOne = am.get(Assets.FX_FILE_PICK_UP_POWERONE, Sound.class);
        pickUpPowerTwo = am.get(Assets.FX_FILE_PICK_UP_POWERTWO, Sound.class);
        pickUpPowerThree = am.get(Assets.FX_FILE_PICK_UP_POWERTHREE, Sound.class);
        pickUpPowerFour = am.get(Assets.FX_FILE_PICK_UP_POWERFOUR, Sound.class);
        ...
        showUpColOne = am.get(Assets.FX_FILE_SHOW_UP_COLONE, Sound.class);
        showUpColSilverBullet = am.get(Assets.FX_FILE_SHOW_UP_COLSILVERBULLET, Sound.class);
        showUpPowerOne = am.get(Assets.FX_FILE_SHOW_UP_POWERONE, Sound.class);
        showUpPowerTwo = am.get(Assets.FX_FILE_SHOW_UP_POWERTWO, Sound.class);
        showUpPowerThree = am.get(Assets.FX_FILE_SHOW_UP_POWERTHREE, Sound.class);
        showUpPowerFour = am.get(Assets.FX_FILE_SHOW_UP_POWERFOUR, Sound.class);
        ...
        aplause = am.get(Assets.FX_FILE_APLAUSE, Sound.class);
