...
public class Constants {
    ...
    public static final float HUD_PAUSE_CONTAINER_PADLEFT = 20.0f;
    public static final float HUD_PAUSE_CONTAINER_WIDTH = 30.0f;
    public static final float HUD_RESUME_CONTAINER_WIDTH = 130.0f;
