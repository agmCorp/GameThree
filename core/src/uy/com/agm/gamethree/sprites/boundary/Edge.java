...
public class Edge {
    ...
    public Edge(PlayScreen screen, boolean isUpper) {
        ...
        if (isUpper) {
            this.bounds = new Rectangle(0, Constants.V_HEIGHT / Constants.PPM - Constants.EDGE_HEIGHT_METERS, Constants.EDGE_WIDTH_METERS, Constants.EDGE_HEIGHT_METERS);
        } else {
            this.bounds = new Rectangle(0, 0, Constants.EDGE_WIDTH_METERS, Constants.EDGE_HEIGHT_METERS);
        }
        defineEdge();
    ...
    private void defineEdge() {
        ...
        fdef.filter.maskBits = Constants.FINALLEVELONE_BIT |
